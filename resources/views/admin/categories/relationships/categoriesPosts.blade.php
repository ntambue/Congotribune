...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-categoriesPosts">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  $('.datatable-categoriesPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
