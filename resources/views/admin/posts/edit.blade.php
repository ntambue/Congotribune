            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('categories') ? 'is-invalid' : '' }}" name="categories_id" id="categories_id" required>
                    @foreach($categories as $id => $categories)
                        <option value="{{ $id }}" {{ ($post->categories ? $post->categories->id : old('categories_id')) == $id ? 'selected' : '' }}>{{ $categories }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('author') ? 'is-invalid' : '' }}" name="author_id" id="author_id" required>
                    @foreach($authors as $id => $author)
                        <option value="{{ $id }}" {{ ($post->author ? $post->author->id : old('author_id')) == $id ? 'selected' : '' }}>{{ $author }}</option>
                    @endforeach
                </select>
