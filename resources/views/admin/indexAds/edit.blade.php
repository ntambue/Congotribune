...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.indexAd.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.index-ads.update", [$indexAd->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="code_a_728_x_90">{{ trans('cruds.indexAd.fields.code_a_728_x_90') }}</label>
                <textarea class="form-control {{ $errors->has('code_a_728_x_90') ? 'is-invalid' : '' }}" name="code_a_728_x_90" id="code_a_728_x_90">{{ old('code_a_728_x_90', $indexAd->code_a_728_x_90) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('code_b_728_x_90') ? 'is-invalid' : '' }}" name="code_b_728_x_90" id="code_b_728_x_90">{{ old('code_b_728_x_90', $indexAd->code_b_728_x_90) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('code_c_728_x_90') ? 'is-invalid' : '' }}" name="code_c_728_x_90" id="code_c_728_x_90">{{ old('code_c_728_x_90', $indexAd->code_c_728_x_90) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_d_728_x_90') ? 'is-invalid' : '' }}" type="text" name="code_d_728_x_90" id="code_d_728_x_90" value="{{ old('code_d_728_x_90', $indexAd->code_d_728_x_90) }}">
