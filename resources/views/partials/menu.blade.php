                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @can('ads_category_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.ads-categories.index") }}" class="nav-link {{ request()->is('admin/ads-categories') || request()->is('admin/ads-categories/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-cogs nav-icon">
            ...
            @can('advertising_access')
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        @can('index_ad_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.index-ads.index") }}" class="nav-link {{ request()->is('admin/index-ads') || request()->is('admin/index-ads/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-cogs nav-icon">

                                    </i>
                                    {{ trans('cruds.indexAd.title') }}
                                </a>
                            </li>
                        @endcan
                    </ul>
