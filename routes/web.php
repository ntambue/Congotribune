...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Index Ads
    Route::delete('index-ads/destroy', 'IndexAdsController@massDestroy')->name('index-ads.massDestroy');
    Route::resource('index-ads', 'IndexAdsController');

    // Ads Categories
    Route::delete('ads-categories/destroy', 'AdsCategoriesController@massDestroy')->name('ads-categories.massDestroy');
